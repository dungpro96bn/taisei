        ...
        <div class="attempt-list">
            <div class="attempt-item js-fadein">
                <picture>
                    ...
                    <img class="mvPicture" src="{{asset('images/contentBox/top_image05_pc@2x.png')}}" alt="聴覚障害社員">
                </picture>
                <div class="info">
                    <p class="ttl">聴覚障がい</p>
            ...
            <div class="attempt-item js-fadein">
                <picture>
                    ...
                    <img class="mvPicture" src="{{asset('images/contentBox/top_image06_pc@2x.png')}}" alt="上下肢障碍者の車いす">
                </picture>
                <div class="info">
                    <p class="ttl">上下肢障がい、車いす利用者</p>
            ...
            <div class="attempt-item js-fadein">
                <picture>
                    ...
                    <img class="mvPicture" src="{{asset('images/contentBox/top_image07_pc@2x.png')}}" alt="精神・発達障がい社員">
                </picture>
                <div class="info">
                    <p class="ttl">精神・発達障がい</p>
            ...
            <div class="attempt-item js-fadein">
                <picture>
                    ...
                    <img class="mvPicture" src="{{asset('images/contentBox/top_image08_pc@2x.png')}}" alt="入社後のフォロー体制">
                </picture>
                <div class="info">
                    <p class="ttl">入社後も安心のフォロー体制</p>
                    <p class="text">本社・各支店に障がい者職業生活指導員を配置したり、臨床心理士と産業カウンセラー・ジョブコーチの有資格者が、本社及び全国の各支店の困りごとに対応しています。<br/>また、障がいのある社員や上司と個々に面接して、フォローを行います。</p>
                </div>
            </div>
        </div>
