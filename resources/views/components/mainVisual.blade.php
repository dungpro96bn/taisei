...
$sliderImgList = array(
    'pc' => array(
//        'mv_movie_pc.mp4',
        'top_img_main_01_pc@2x.png',
        'top_img_main_02_pc@2x.png',
    ),
    'sp' => array(
//        'mv_movie_sp.mp4',
        'top_img_main_01_sp@2x.png',
        'top_img_main_02_sp@2x.png',
    ),
);
$mvCatchCopy = '高い場所から見た東京の街の景色';//メインビジュアルのキャッチコピーを「''」内に入力してください
?>
