        ...
        <main id="main_wrap">
            ...
            <div id="attempt">
                ...
                <div id="attempt-01" class="attemptContent">
                    <div class="inner">
                        <h2 class="heading-block"><span>聴覚障害</span></h2>
                        <div class="attemptContent-box">
                            <div class="content">
                                <ul class="list-textCheck">
                                    <li class="item-textCheck"><p>対話をする時は口の動きが読めるように、<span>口を見せてはっきりと話す</span></p></li>
                                    <li class="item-textCheck"><p>日常業務で<span>音声文字化ツール利用</span>の全社周知と啓発</p></li>
                                    <li class="item-textCheck"><p>Microsoft<span> Teamsのチャット</span>での<br class="sp-br"/>コミュニケーション</p></li>
                                    <li class="item-textCheck"><p><span>電話応対免除</span></p></li>
                                    <li class="item-textCheck"><p>ブギーボードなどで<span>筆談</span></p></li>
                                    <li class="item-textCheck"><p>本社内の館内放送と同じ内容を<br class="sp-br"/><span>メール配信</span></p></li>
                                    <li class="item-textCheck"><p>入社式や内定式、災害訓練の防災セミナーなどで<span>音声文字化ツールや手話通訳による情報保障</span></p></li>
                                </ul>
                                <ul class="imageList">
                                    <li class="imageItem">
                                        <picture>
                ...
                <div id="attempt-02" class="attemptContent">
                    <div class="inner">
                        <h2 class="heading-block"><span>上下肢障がい・車いす利用者</span></h2>
                        <div class="attemptContent-box">
                            <div class="content">
                                <ul class="list-textCheck">
                                    <li class="item-textCheck"><p><span>ユニバーサルトイレ</span>の導入</p></li>
                                    <li class="item-textCheck"><p>車いすの高さに合わせて<br class="sp-br"/><span>上げ下げできるデスク</span>の導入</p></li>
                                    <li class="item-textCheck"><p>重量物の<span>運搬業務を避ける</span>よう配慮</p></li>
                                </ul>
                                <ul class="imageList">
                                    <li class="imageItem">
                                        <picture>
                ...
                <div id="attempt-03" class="attemptContent">
                    <div class="inner">
                        <h2 class="heading-block"><span>精神・発達障がい</span></h2>
                        <div class="attemptContent-box">
                            <div class="content">
                                <ul class="list-textCheck">
                                    <li class="item-textCheck"><p>周囲の視線が気になる社員のために<br class="sp-br"/><span>パーテーションを設置</span></p></li>
                                    <li class="item-textCheck"><p>後ろを通られるのが苦手という社員もいるので、<span>座席の位置を面接の際に確認</span></p></li>
                                    <li class="item-textCheck"><p>外部からの刺激（音・光など）に<br class="sp-br"/>過敏に反応してしまう場合、<br/>耳栓やサングラスなどの<span>保護具を使用可</span></p></li>
                                </ul>
                                <ul class="imageList">
                                    <li class="imageItem">
                                        <picture>
                ...
                <div id="attempt-04" class="attemptContent">
                    <div class="inner">
                        <h2 class="heading-block"><span>その他</span></h2>
                        <div class="attemptContent-box">
                            <div class="content item-flex">
                                ...
                                <ul class="list-textCheck">
                                    <li class="item-textCheck"><p>本社・各支店に<br class="sp-br"/><span>障がい者職業生活指導員</span>を配置<br/>（産業医・健康管理室と密に連携してサポート）</p></li>
                                    <li class="item-textCheck"><p>臨床心理士と産業カウンセラー・ジョブコーチの有資格者が、<span>本社及び全国の各支店の困りごとに対応</span></p></li>
                                    <li class="item-textCheck"><p>障がいのある社員や上司と、<br class="sp-br"/><span>個々に面接してフォロー</span>を行います</p></li>
                                </ul>
                            </div>
                        </div>
                        <div class="message-boss">
