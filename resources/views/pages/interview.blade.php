                    ...
                    <div class="inner">
                        ...
                        <div class="interviewList-qa">
                            <div class="interviewItem-qa">
                                <h2 class="title"><span>大成建設への志望動機と<br class="sp-br"/>入社理由を教えてください。</span></h2>
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        <p class="text">私は就職活動を進める中で、重視していたポイントが2つありました。1つ目が防災や減災などの自然災害の復旧に関わっている企業であること。2つ目が自分の中でこれだけは譲れないと思っていた企業選びの条件にすべて当てはまっていることです。</p>
                                        <p class="text">1つ目の理由は、私の障害に全く関係なく、大学の授業を受けていたときに「これからの日本は自然災害が多発し、防災ではなく減災という考えが重要になる」と教わって、その言葉が心に残ったので復旧作業に携わっている企業に行きたいと思いました。</p>
                                        <p class="text">2つ目の理由は、私の障害に関係しているのですが、車いすを置ける場所を確保できる環境であることや、電車での通勤が不安なくできる場所に会社があるかなどを、企業選びをする上で重視していました。この譲れない条件は、面接の質問のときに会社に伝えていたので面接後に社内を見学できたり、選考が進む中で不安が解消されたので良かったと思っています。</p>
                                        <p class="text">あとは、面接など社員の方とお話しする際に、過度に緊張せず私の考えを自分らしい言葉で伝えられたので、大成建設に入社したいなと思いました。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="interviewItem-qa">
                                <h2 class="title"><span>所属部署における仕事内容と役割は？</span></h2>
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        <p class="text">現在配属しているチームの仕事は、人事部の中でも障がい者採用だったり、出産・育児に関する支援などのいわゆるD&I（ダイバーシティー&インクルージョン）に関する仕事をしています。</p>
                                        <p class="text">私は1年目のとき、チーム内の経理業務を担当していました。<br/>
                                        ...
                                        <p class="text">2年目の現在は、パワーポイントで研修資料を作成したり、会場の用意の段取りなどを行っています。</p>
                                        <p class="text">また、月初に育休のデータを集計して、各支店の担当者の方に連絡を送っています。お子様の生まれた社員の方から社内制度について質問が来た際は、育休についての説明をすることもあります。</p>
                                        <p class="text">また、電話対応も行っています。その時は、メモが取りやすいように電話機からパソコンに転送させて電話を取っています。片手が不自由でも電話対応ができるので嬉しいです。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="interviewItem-qa">
                                <h2 class="title"><span>どんなサポートを受けていますか？</span></h2>
                                <div class="qaInfo img-text01">
                                    ...
                                    <div class="textInfo">
                                        <p class="text">電動車いすで通勤しているので、オフィスの入り口のドアを1つ、スライド式に変更していただきました。<br/>
                                            入社前に会社見学をさせてもらいましたが、その際に私が車いすでドアの開閉に苦労している様子をみて、会社側からスライドドアへの変更を打診してくださいました。スライドドアだと自分で開閉できるため助かっています。</p>
                                        <p class="text">また、室内は車いすから降りて歩きたいという希望があったため、車いすを置いておく場所を確保していただいています。<br/>
                            ...
                            <div class="interviewItem-qa">
                                <h2 class="title"><span>就職活動中のみなさんへ<br class="sp-br"/>メッセージを！</span></h2>
                                <div class="qaInfo img-text02">
                                    <div class="textInfo">
                                        <p class="text">就職活動を進めるうえで、この会社で私にできることがあるかな…という不安や、障がいへの配慮がちゃんとあるのかな？などの疑問があるかと思います。<br class="sp-br"/><br class="sp-br"/>実際私が就活していた時もとても不安でした。<br class="pc-br"/>
                                        ...
                                        <p class="text sp-br">私が学生のときに受けている会社は少なかったですが、それでも大成建設を自分から選んで入社すると決めたので、納得感を持って就職活動を終わらせることができました。<br/><br class="sp-br"/>
                                ...
                                <div class="qaInfo pc-br">
                                    <div class="textInfo">
                                        <p class="text">私が学生のときに受けている会社は少なかったですが、それでも大成建設を自分から選んで入社すると決めたので、納得感を持って就職活動を終わらせることができました。<br/>
                                            就職活動を頑張っている皆さんにも、色々な企業と比較したうえで納得感をもって大成建設に入社してもらいたいです。本社や支店など皆さんが活躍できる場所はたくさんあるので、是非お待ちしています。</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="inner">
                        ...
                        <div class="interviewList-qa">
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        <p class="text">将来は地域社会や生活に必要なモノに携わる企業で働きたいという思いがあり、大学はまちづくり専攻のゼミに在籍していました。<br/>
                                            在学中に一度、建設業界とは全く別ジャンルの企業で業務委託として働きましたが、生活に必要なモノとは何なのかと色々模索していく中で建設業界に興味持ち始めました。
                                        </p>
                                        <p class="text">沢山の建設会社のWebサイトを見た中からいちばん惹かれたのが大成建設で、「地図に残る仕事。」というキャッチコピーが脳裏に焼き付けられました。<br/>
                                            自分が挑戦したい企業はここだと確信し、内定をいただけたら絶対入社しようと決めていました。
                                        </p>
                                        <p class="text">志望動機は、大成建設公式サイトに掲載している理念体系、<br/>
                                            「人がいきいきとする環境を創造する」<br/>
                            ...
                            <div class="interviewItem-qa">
                                <h2 class="title"><span>所属部署における<br class="sp-br"/>仕事内容と役割は？</span></h2>
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        <p class="text">所属部署は営業推進本部企画推進部プロモーション室です。<br/>
                                        ...
                                        <p class="text">内容は、Technology&Solutionサイトの運用、ニュース・記事作成、パンフレット更新等です。<br/>
                                            入社した頃誰しもが一度は通る道でしょうが、新しい環境に慣れなかったときは苦労しました。</p>
                                        <p class="text">あれから1年経ち、1人でニュースや記事をイチから作成しサイトに公開するまでに成長できたと思います。<br/>
                                            知識を蓄えることで、理解してるからこそ作れるモノが増え、とても楽しくお仕事をしています。</p>
                                        <p class="text">自分が作成したニュースや記事へ実際に世界中からアクセスがあり、色々な方が見て下さっているということを感じられ、とてもやりがいのある仕事です。展示会出展の際は、記事作成にあたっての写真撮影や、展示会のお手伝いすることもあり、様々な業務や豊かな知識に触れる機会が多い部署です。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo img-text01">
                                    ...
                                    <div class="textInfo">
                                        <p class="text">会社からはiPad・ブギーボードを提供しても<br class="sp-br"/>らっています。<br/>
                                        ...
                                        <p class="text">入社の際から人事部の担当者には、過度な配慮ではなく合理的な配慮で支援していただいてます。<br/>
                            ...
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo img-text02">
                                    <div class="textInfo">
                                        <p class="text">就職活動はあなたの魅力や実力を企業に見てもらえるチャンスだと、私はそう思っています。<br/>
                                            自分の気持ちや想いを大切にして素直に突き進んでください！</p>
                                        <p class="text">大成建設で働きたい気持ち、叶えたい想い、そしてあなたの夢をぜひ当社へ大きく語ってください。<br/>
