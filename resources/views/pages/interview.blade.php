                        ...
                        <div class="interviewList-qa">
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        ...
                                        <p class="text js-fadein">1つ目の理由は、私の障がいに全く関係なく、大学の授業を受けていたときに「これからの日本は自然災害が多発し、防災ではなく減災という考えが重要になる」と教わって、その言葉が心に残ったので復旧作業に携わっている企業に行きたいと思いました。</p>
                                        <p class="text js-fadein">2つ目の理由は、私の障がいに関係しているのですが、車いすを置ける場所を確保できる環境であることや、電車での通勤が不安なくできる場所に会社があるかなどを、企業選びをする上で重視していました。この譲れない条件は、面接の質問のときに会社に伝えていたので面接後に社内を見学できたり、選考が進む中で不安が解消されたので良かったと思っています。</p>
                                ...
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        ...
                                        <p class="text js-fadein">私は1年目のとき、チーム内の経理業務を担当していました。<br/>
                                            ...
                                            他にも研修を行う際の名簿をエクセルで作成したり、研修実施後のアンケートの集計を行っていました。</p>
                                        ...
                                        <p class="text js-fadein">また、電話対応も行っています。そのときは、メモが取りやすいように電話機からパソコンに転送させて電話を取っています。片手が不自由でも電話対応ができるので嬉しいです。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo img-text01">
                                    ...
                                    <div class="textInfo">
                                        ...
                                        <p class="text js-fadein">また、室内は車いすから降りて歩きたいという希望があったため、車いすを置いておく場所を確保していただいています。<br/>
                                            他にも、部署内で席替えがあるときにも、必ずこの席で移動に問題がないか確認を一緒にしてくださいます。 電話対応も左手に障がいがある分、メモが取りやすいようパソコンで電話が取れるように設定をしました。<br/>
                            ...
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo img-text02">
                                    <div class="textInfo">
                                        <p class="text js-fadein">就職活動を進めるうえで、この会社で私にできることがあるかな…という不安や、障がいへの配慮がちゃんとあるのかな？などの疑問があるかと思います。<br class="sp-br"/><br class="sp-br"/>実際私が就活していたときもとても不安でした。<br class="pc-br"/>
                                ...
                                <div class="qaInfo pc-br">
                                    <div class="textInfo">
                                        <p class="text js-fadein">私が学生のときに受けている会社は少なかったですが、それでも大成建設を自分から選んで入社すると決めたので、納得感を持って就職活動を終わらせることができました。<br/>
                                            就職活動を頑張っている皆さんにも、色々な企業と比較したうえで納得感をもって大成建設に入社してもらいたいです。本社や支店など皆さんが活躍できる場所はたくさんあるので、ぜひお待ちしています。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="messageBox js-fadein">
                                <div class="messageInfo">
                                    ...
                                    <p class="text">現在は、部門のWebサイトの修正、育休取得促進に関する業務、フレックス勤務者の集計を始め、様々な業務にチャレンジしています。<br/>
                                        ...
                                        また、業務を行う環境面で困ったことが起きても、自身で対応できるときには責任をもって対応し、それが難しいと判断したときには、きちんと周囲の人に助けを求めることができるなど、高いコミュニケーション能力のおかげで、部署としても大変助かっています。</p>
                                </div>
                                ...
                                <ul class="oneDay-list">
                                    ...
                                    <li class="oneDay-item">
                                        ...
                                        <div class="oneDay-box">
                                            ...
                                            <p class="text">先輩方とお話したり、自席でお弁当を食べたりしています。</p>
                                        </div>
                                    </li>
                                    <li class="oneDay-item">
                                        <picture class="iconTime">
                                        ...
                                        <div class="oneDay-box">
                                            ...
                                            <p class="text">先輩方と打ち合わせをしたり、社外の人と打ち合わせすることもあります。</p>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="oneDay-list">
                                    ...
                                    <li class="oneDay-item">
                                        ...
                                        <div class="oneDay-box">
                                            ...
                                            <p class="text">できなかった仕事は次の日に続きができるよう、整理してから退勤します。</p>
                                        </div>
                                    </li>
                                    <li class="oneDay-item">
                                        <picture class="image">
                ...
                <div id="interview-02" class="interviewContent">
                    <div class="inner">
                        <div class="interview-banner js-fadein">
                            <div class="bannerInfo">
                                <div class="infoInner">
                                    <h2 class="ttl">過度ではない配慮のおかげで<br/>障がいの壁を感じずに<br/>仕事ができる環境です</h2>
                        ...
                        <div class="interviewList-qa">
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        <p class="text js-fadein">将来は地域社会や生活に必要なモノに携わる企業で働きたいという想いがあり、大学はまちづくり専攻のゼミに在籍していました。<br/>
                                            在学中に一度、建設業界とは全く別ジャンルの企業で業務委託として働きましたが、生活に必要なモノとは何なのかと色々模索していく中で建設業界に興味を持ち始めました。</p>
                                        <p class="text js-fadein">沢山の建設会社のWebサイトを見た中からいちばん惹かれたのが大成建設で、「地図に残る仕事。」というキャッチコピーが脳裏に焼き付けられました。<br/>
                                            自分が挑戦したい企業はここだと確信し、内定をいただけたら絶対に入社しようと決めていました。
                                        </p>
                                ...
                                <div class="qaInfo">
                                    <div class="textInfo">
                                        ...
                                        <p class="text js-fadein">内容は、Technology&Solutionサイトの運用、ニュース・記事作成、パンフレット更新等です。<br/>
                                            入社したての頃に誰しもが一度は通る道でしょうが、新しい環境に慣れなかったときは苦労しました。</p>
                                        <p class="text js-fadein">あれから1年経ち、1人でニュースや記事をイチから作成しサイトに公開するまでに成長できたと思います。<br/>
                                            知識を蓄えることで、理解してるからこそ作れるモノが増え、とても楽しく仕事をしています。</p>
                                        <p class="text js-fadein">自分が作成したニュースや記事へ実際に世界中からアクセスがあり、色々な方が見て下さっているということを感じられ、とてもやりがいのある仕事です。展示会出展の際は、記事作成にあたっての写真撮影や、展示会のお手伝いをすることもあり、様々な業務や豊かな知識に触れる機会が多い部署です。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="interviewItem-qa">
                                ...
                                <div class="qaInfo img-text01">
                                    ...
                                    <div class="textInfo">
                                        <p class="text js-fadein">会社からはiPad・ブギーボードを提供しても<br class="sp-br"/>らっています。<br/>
                                            ...
                                            ブギーボードは同僚の社員に1人1ずつ配付されており、業務会話や質問の際に活用しています。<br/>
                            ...
                            <div class="messageBox js-fadein">
                                <div class="messageInfo">
                                    ...
                                    <p class="text">現在担当してもらっている業務は、主にテクノロジー＆ソリューションサイトの記事制作やメールマガジンの発行を行うことです。<br/>
                                        日々のコミュニケーションはTeamsや携帯の文字起こし機能を使用してのやり取りになりますが、打ち合わせなどでは積極的に自身の意見を述べてくれます。<br/><br class="sp-br"/>
                                        サイトデザイン等、打ち合わせでの表現が細かくなる作業も少なくない中、しっかりと理解するまで説明を受けるなど、責任感を持って業務にあたってくれていることを実感します。</p>
                                </div>
                                <div class="messageImage">
                                    <picture class="image">
