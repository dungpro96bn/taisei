...
Route::get('/attempt', [ContentController::class, 'show'])->defaults('path', 'attempt')->name('attempt');
Route::get('/interview', [ContentController::class, 'show'])->defaults('path', 'interview')->name('interview');
